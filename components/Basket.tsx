  ...
  return (
    <div className='max-w-7xl mx-auto'>
                ...
                return(
                    ...
                    className='p-5 my-2 flex items-center justify-between'>
                        ...
                        <div className='flex space-x-4 pl-4'>
                            <div>
                                <p className='linne-clamp-1 font-bold'>{item.title}</p>
                                <div 
        ...
        <div className='flex flex-col justify-end p-5'>
            <p className='font-bold text-right text-walmart mb-5'>
                Total: {basketTotal}
            </p>
            <Button className='mt-5 h-20 bg-walmart hover:bg-walmart/50 text-slate-50'>
                Checkout
            </Button>
        </div>
    </div>
